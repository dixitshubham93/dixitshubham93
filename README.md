# Hi there, I'm Shubham Dixit 👋

**Computer Science Student | Full-Stack Developer | Problem Solver**

I'm a B.Tech CSE student at IIIT Bhopal with a passion for building scalable web applications and solving complex problems. I enjoy working across the full stack and love experimenting with creative, interactive UIs.
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=c,cpp,python,js,ts,react,nextjs,tailwind,nodejs,express,mongodb,postgres,mysql,prisma,git,github,docker,postman,vscode,vercel" alt="Tech Stack" />
</p>
...
- 3D spatial feed system using **Framer Motion & WebGL**
- OAuth 2.0 + JWT authentication with role-based authorization

### 🏆 Smart India Hackathon Project
Internal workflow solution that improved team efficiency and satisfaction.
